		...
		<header className="flex flex-col items-center mt-20 w-full relative isolate group">
			...
			>
				<div
					...
					className={`relative left-[calc(50%+11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#9333ea] to-[#4c1d95] sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] group-hover:opacity-80 dark:group-hover:opacity-60 transition-opacity duration-500 ${
						isVisible
